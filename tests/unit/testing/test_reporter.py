...
def mock_metrics():
    return EvaluationMetrics(
        ...
        by_difficulty={
            "easy": {"total": 1, "passed": 1, "avg_correctness": 1.0},
...
def mock_evaluator():
    ...
    res1 = TestCaseResult(
        ...
        generated_sql="S1",
        actual_results=[],
        result_correctness=ResultCorrectnessMetric(
            score=1.0,
            is_correct=True,
            missing_rows=0,
            extra_rows=0,
        ...
        confidence_calibration=ConfidenceCalibration(
            predicted_confidence=0.9, actual_accuracy=0.9, calibration_error=0.0, is_calibrated=True
        ),
...
def test_generate_markdown_report(tmp_path, mock_evaluator, mock_metrics):
    ...
    result_path = ReportGenerator.generate_markdown_report(
        mock_evaluator, mock_metrics, output_path
    )
