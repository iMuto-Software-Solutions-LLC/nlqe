...
def mock_metrics():
    return EvaluationMetrics(
        total_tests=2, passed_tests=2, failed_tests=0, accuracy=1.0, 
        avg_result_correctness=1.0, avg_answer_quality=1.0, avg_confidence_score=0.9, 
        confidence_calibration_error=0.0, execution_time_ms=10.0,
