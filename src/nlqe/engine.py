...
from nlqe.datasource.manager import DataSourceManager
from nlqe.duckdb.executor import DuckDBExecutor
from nlqe.llm.client import (
    LLMClient,
    anthropic_client,
...
class QueryEngine:
    """Main NLQE class — primary user interface.
        ...
        if provider == "openai":
            if not self.config.openai_api_key:
                raise ConfigurationError(
                    ...
                    "Set NLQE_OPENAI_API_KEY in your environment or .env file."
                )
        ...
        if provider == "anthropic":
            if not self.config.anthropic_api_key:
                raise ConfigurationError(
                    ...
                    "Set NLQE_ANTHROPIC_API_KEY in your environment or .env file."
                )
