...
from nlqe.testing.datasets import DatasetLoader
from nlqe.testing.evaluator import Evaluator
from nlqe.testing.metrics import AnswerQualityEvaluator
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="NLQE Evaluation Framework",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Run full evaluation with all test cases
  python -m nlqe.testing.cli evaluate --config .env --dataset fixtures/golden_datasets.yaml

  # Evaluate only easy tests
  python -m nlqe.testing.cli evaluate --config .env --dataset fixtures/golden_datasets.yaml --difficulty easy

  # Evaluate specific category
  python -m nlqe.testing.cli evaluate --config .env --dataset fixtures/golden_datasets.yaml --category aggregation

  # Generate reports in all formats
  python -m nlqe.testing.cli evaluate --config .env --dataset fixtures/golden_datasets.yaml --output reports/ --report-formats json csv markdown
        """,
    )
